import re
from app.visualiser.visual.handlers.abstract_color import AbstractNodeColorHandler
from app.visualiser.visual.handlers.abstract_color import AbstractEdgeColorHandler
