...
class TestSearch(unittest.TestCase):
    ...
    def test_get_entities(self):
        ...
        for entity in entities:
            self.assertIsNotNone(entity.get_type())
...
class TestViews(unittest.TestCase):
    ...
    def test_pruned(self):
        ...
        for edge in graph.edges():
            self.assertTrue(edge.get_type()) in self._wrapper.model.identifiers.predicates
    ...
    def test_interaction_verbose(self):
        ...
        for edge in graph.edges():
            ...
            if n_type in interactions_classes:
                self.assertTrue(self._wrapper.model.is_derived(URIRef(v_type),pe_class_code))
            elif v_type in interactions_classes:
                self.assertTrue(self._wrapper.model.is_derived(URIRef(v_type),interaction_class_code))
            else:
