...
from  app.graph.design_graph.converter.utility.graph import SBOLGraph
from  app.graph.design_graph.converter.common import map_to_nv, get_name, _derive_graph_name
...
def convert(filename, neo_graph, mode, graph_name):
    ...
    def _add_edge(n, v, e):
        ...
        neo_graph.add_edge(n, v, str(e), mode=mode, **properties)
